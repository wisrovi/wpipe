...
wpipe simplifies orchestration. No complex class inheritance; just decorate your pure Python logic with @step, add it to a Pipeline, and run. Your pipeline lives inside your app.
