...
Define a greet step that returns a personalized message, wire it into a Pipeline, and run. From there you keep scaling: conditions, loops, parallelism, checkpoints, async, dashboard.
