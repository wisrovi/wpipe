...
Why deploy a full service when you only need a robust library? Redefining micro-orchestration.
...
If your pipeline doesn't need thousands of tasks distributed across a Kubernetes cluster, maybe you don't need an orchestrator-as-a-service. You need EMBEDDED ORCHESTRATION. That's where wpipe changes the game.
