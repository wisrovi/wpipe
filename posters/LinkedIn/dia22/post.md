...
- **Forensic Error Capture:** Get the exact file and line of the failure. No more digging through JSON nodes.
...
graph LR
    subgraph n8n
    A[Visual Node] --> B[Hidden Logic Error]
    B --> C[Manual Debugging]
    end
    subgraph WPipe
    D[Python @state] --> E[Auto-Checkpoint]
    E --> F[Forense Traceback]
    end
```
