            ...
            <div style="position: relative; z-index: 1; height: 100%; display: flex; flex-direction: column; justify-content: space-between;">
                ...
                <div style="display: flex; justify-content: space-between; align-items: flex-end; padding: 15px 30px; border-top: 1px solid rgba(255,255,255,0.1); margin-top: 10px;">
                    <div style="text-align: left; opacity: 0.9; font-family: 'Courier New', monospace; line-height: 1.4;">
                        ...
                        <p style="margin: 0; color: #64748b; font-size: 0.8em; margin-bottom: 8px;">ID: WP-50-ARQ-ONZE</p>
                        <p style="margin: 0; font-weight: 900; color: #fff; font-size: 1.2em; letter-spacing: 1px;">WISROVI SUITE • <span style="color: #f59e0b;">WISROVI.DEV</span></p>
                    ...
                    <div style="width: 100px; height: 100px; background: #f59e0b; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 3.5em; box-shadow: 0 0 30px #f59e0b66; border: 4px solid rgba(255,255,255,0.1);">📐</div>
                </div>
            </div>
        </div>
