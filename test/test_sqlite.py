...
class TestSQLite:
    ...
    def test_sqlite_write_and_read(self, db_file):
        ...
        with SQLite(db_name=db_file) as sqlite:
            record_id = sqlite.write(input="test_input", output={"key": "value"})
    ...
    def test_sqlite_write_dict_input(self, db_file):
        ...
        with SQLite(db_name=db_file) as sqlite:
            ...
            record_id = sqlite.write(input=input_dict)
            assert record_id is not None
    ...
    def test_sqlite_update_record(self, db_file):
        ...
        with SQLite(db_name=db_file) as sqlite:
            record_id = sqlite.write(input="original", output="original_output")
            sqlite.write(output="updated_output", id=record_id)
    ...
    def test_sqlite_count_records(self, db_file):
        ...
        with SQLite(db_name=db_file) as sqlite:
            sqlite.write(input="record1", output="out1")
            sqlite.write(input="record2", output="out2")
    ...
    def test_sqlite_delete_record(self, db_file):
        ...
        with SQLite(db_name=db_file) as sqlite:
            record_id = sqlite.write(input="to_delete", output="out")
    ...
    def test_sqlite_export_to_dataframe(self, db_file):
        ...
        with SQLite(db_name=db_file) as sqlite:
            sqlite.write(input="test1", output="out1")
    ...
    def test_sqlite_get_records_by_date_range(self, db_file):
        ...
        with SQLite(db_name=db_file) as sqlite:
            sqlite.write(input="test", output="out")
    ...
    def test_sqlite_async_write(self, db_file):
        ...
        with SQLite(db_name=db_file) as sqlite:
            record_id = sqlite.async_write(input="async_test", output="async_out")
